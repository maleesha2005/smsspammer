...
def prsent(count,num):
	sys.stdout.write('\r' +random.choice(fore) +Style.BRIGHT+'\t[*]'+' Spamming '+str(num)+'\t'+str(count)+' Sent')
	sys.stdout.flush()
def Spinner():
	l=['|','/','-','\\']
	for i in l+l+l:
...
if cho==1:
	...
	if ag == 'Y' or ag == 'y':
		os.system('python3 smsspammer.py')
	else:
		exit()
elif cho == 2:
	os.system('clear')
